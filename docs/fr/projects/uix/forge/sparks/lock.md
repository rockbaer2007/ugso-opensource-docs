---
title: Lock Spark
description: Page française préparée pour Lock Spark dans la documentation UGSo Open Source.
---
# Lock Spark
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/forge/sparks/lock.md`](/en/projects/uix/forge/sparks/lock).
