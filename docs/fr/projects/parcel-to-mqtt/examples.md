---
title: Parcels
description: Page française préparée pour Parcels dans la documentation UGSo Open Source.
---
# Parcels
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/parcel-to-mqtt/examples.md`](/en/projects/parcel-to-mqtt/examples).
