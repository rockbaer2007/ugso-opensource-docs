---
title: Directives
description: Page française préparée pour Directives dans la documentation UGSo Open Source.
---
# Directives
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/broker/directives.md`](/en/projects/uix/broker/directives).
