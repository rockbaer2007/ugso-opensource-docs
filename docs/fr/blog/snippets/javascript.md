...
description: Page française préparée pour JavaScript Snippets dans la documentation UGSo Open Source.
---
# JavaScript Snippets
...
La page anglaise correspondante est actuellement la référence de structure : [`en/blog/snippets/javascript.md`](/en/blog/snippets/javascript).
