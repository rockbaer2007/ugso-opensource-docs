...
description: Page française préparée pour UIX Documentation dans la documentation UGSo Open Source.
---
# UIX Documentation
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/index.md`](/en/projects/uix/).
