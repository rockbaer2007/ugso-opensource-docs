...
| Project | Status | Note |
| --- | --- | --- |
| [Dashboard Layout Card V2](https://github.com/rockbaer2007/lovelace-layout-card-v2) | experimental | Fork of Lovelace layout-card with dedicated V2 layout types, side tab menu, subviews, new subviews defaulting to Sections V2, home entry, theme inheritance from the home view, clock/date display, optional analog hour/minute marks, colors, 3D frames, dividers that inherit colors from the previous divider and optional hiding of the Home Assistant header/sidebar. |
