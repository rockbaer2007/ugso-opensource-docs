...
::: details Insérer après un élément une icône fixe de couleur bleue
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Insérer l'icône d'état d'une entité avant un élément
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Insérer une icône à partir d'un chemin SVG
...
:::
::: details Insérer une image comme icône
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Traverser une racine Shadow DOM pour atteindre un élément imbriqué
```yaml
type: custom:uix-forge
forge:
  mold: card
