...
description: Page française préparée pour Verified Plugins dans la documentation UGSo Open Source.
---
# Verified Plugins
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/atlas-plugins/verified-plugins.md`](/en/projects/atlas-plugins/verified-plugins).
