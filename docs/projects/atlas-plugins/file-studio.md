...
- aktueller Home-Assistant-App/Add-on-Stand: `0.1.174`
...
- direkte Links öffnen Dateien auch dann, wenn sie tiefer liegen als der zuerst
  geladene Dateibaum, zum Beispiel Automation-Exporter-Ausgaben
