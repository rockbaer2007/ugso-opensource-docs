...
- the file tree refreshes after upload without automatically opening the uploaded file
...
- stop uploads above that limit before transfer and direct users to the [Home Assistant Samba add-on](https://github.com/home-assistant/addons/tree/master/samba)
