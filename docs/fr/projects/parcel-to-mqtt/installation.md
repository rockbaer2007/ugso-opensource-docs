...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/parcel-to-mqtt/installation.md`](/en/projects/parcel-to-mqtt/installation).
