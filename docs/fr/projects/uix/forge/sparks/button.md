---
title: Button Spark
description: Page française préparée pour Button Spark dans la documentation UGSo Open Source.
---
# Button Spark
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/forge/sparks/button.md`](/en/projects/uix/forge/sparks/button).
