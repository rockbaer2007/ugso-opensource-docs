---
title: Entités
description: Page française préparée pour Entités dans la documentation UGSo Open Source.
---
# Entités
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/fritzbox-to-mqtt/entities.md`](/en/projects/fritzbox-to-mqtt/entities).
