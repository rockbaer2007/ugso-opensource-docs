...
A Home Assistant app that publishes parcel tracking data as MQTT Discovery entities. The first version uses direct DHL parcel tracking and leaves notifications to normal Home Assistant automations.
