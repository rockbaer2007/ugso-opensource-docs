...
Main menu and submenu entries can optionally define their own colors. Supported overrides are icon color, active icon color, button color and active button color per entry. Empty fields continue to use the global menu style.
