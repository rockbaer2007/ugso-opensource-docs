---
title: Configuration
description: Page française préparée pour Configuration dans la documentation UGSo Open Source.
---
# Configuration
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/fritzbox-to-mqtt/configuration.md`](/en/projects/fritzbox-to-mqtt/configuration).
