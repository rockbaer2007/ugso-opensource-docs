---
title: FAQ
description: Page française préparée pour FAQ dans la documentation UGSo Open Source.
---
# FAQ
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/faq.md`](/en/projects/uix/faq).
