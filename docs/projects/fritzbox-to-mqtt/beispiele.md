...
Diese Lovelace-Karte zeigt die Download- und Uploadrate, die Anrufbeantworter `AB0` bis `AB4` mit neuen und alten Nachrichten sowie den Status von 2,4-GHz-WLAN, 5-GHz-WLAN und Gast-WLAN.
