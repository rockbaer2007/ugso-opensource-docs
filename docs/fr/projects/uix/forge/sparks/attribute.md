...
description: Page française préparée pour Attribute Spark dans la documentation UGSo Open Source.
---
# Attribute Spark
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/forge/sparks/attribute.md`](/en/projects/uix/forge/sparks/attribute).
