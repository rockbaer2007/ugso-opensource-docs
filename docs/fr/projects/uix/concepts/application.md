---
title: Anwendung
description: Page française préparée pour Anwendung dans la documentation UGSo Open Source.
---
# Anwendung
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/concepts/application.md`](/en/projects/uix/concepts/application).
