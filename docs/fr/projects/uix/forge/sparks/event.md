---
title: Event Spark
description: Page française préparée pour Event Spark dans la documentation UGSo Open Source.
---
# Event Spark
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/forge/sparks/event.md`](/en/projects/uix/forge/sparks/event).
