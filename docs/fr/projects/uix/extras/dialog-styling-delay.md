...
description: Page française préparée pour Dialog Styling Delay dans la documentation UGSo Open Source.
---
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/extras/dialog-styling-delay.md`](/en/projects/uix/extras/dialog-styling-delay).
