...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/ultimate-timer/configuration.md`](/en/projects/ultimate-timer/configuration).
