...
description: Page française préparée pour Lovelace and Bubble Card dans la documentation UGSo Open Source.
---
...
La page anglaise correspondante est actuellement la référence de structure : [`en/blog/snippets/lovelace.md`](/en/blog/snippets/lovelace).
