...
description: Quellen, Lizenzhinweise und Änderungsprüfung für die Mushroom-Doku.
---
...
Das Originalprojekt und die englischen Originaldateien bleiben maßgeblich.

## Änderungsprüfung

Die GitHub Action `Check Mushroom docs upstream` prüft regelmäßig, ob sich relevante Dateien im Original-Repository geändert haben.
...
Wenn sich relevante Dateien ändern, erstellt die Action ein Issue mit Vergleichslink und Dateiliste.
