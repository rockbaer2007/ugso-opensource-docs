...
description: Page française préparée pour Interaction Anchors dans la documentation UGSo Open Source.
---
# Interaction Anchors
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/broker/interaction-anchors.md`](/en/projects/uix/broker/interaction-anchors).
