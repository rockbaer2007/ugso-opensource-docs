...
description: Page française préparée pour Background Spark dans la documentation UGSo Open Source.
---
# Background Spark
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/forge/sparks/background.md`](/en/projects/uix/forge/sparks/background).
