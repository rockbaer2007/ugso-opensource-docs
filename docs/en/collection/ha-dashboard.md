...
| Project | Status | Note |
| --- | --- | --- |
| [Dashboard Layout Card V2](https://github.com/rockbaer2007/lovelace-layout-card-v2) | experimental | Fork of Lovelace layout-card with dedicated V2 layout types, side tab menu, subviews, home entry, clock/date display, optional analog hour/minute marks, colors, 3D frames, dividers and optional hiding of the Home Assistant header/sidebar. |
