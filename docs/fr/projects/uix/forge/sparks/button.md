...
::: details Bouton après l'icône Tile avec action de bascule et icône fluorescente
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Bouton avant l'icône Tile avec la variante Danger
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Bouton avec une icône avant et après le libellé
```yaml
type: custom:uix-forge
forge:
  mold: card
...
:::
::: details Bouton avec icône seule
...
:::
::: details Espacement du bouton dans une carte Tile avec les propriétés CSS flex
