...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/heizoel-to-mqtt/configuration.md`](/en/projects/heizoel-to-mqtt/configuration).
