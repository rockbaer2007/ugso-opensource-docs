---
title: DOM
description: Page française préparée pour DOM dans la documentation UGSo Open Source.
---
# DOM
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/concepts/dom.md`](/en/projects/uix/concepts/dom).
