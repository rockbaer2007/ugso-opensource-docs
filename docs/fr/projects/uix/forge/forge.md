...
::: tip "Exemple complet avec une macro"
...
::: details Exemple d'imbrication sur un niveau
...
::: details Exemple avec plusieurs niveaux d'imbrication et résultat
```yaml
type: custom:uix-forge
...
:::
::: details Plusieurs niveaux d'imbrication dans une carte Markdown
...
:::
::: details À lire avant de créer votre propre séquence d'imbrication
...
::: details Exemple avec auto-entities
```yaml
type: custom:auto-entities
filter:
  include:
...
::: details Thème pour le moule inter-contexte card_as_badge
