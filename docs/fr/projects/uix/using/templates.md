---
title: Templates
description: Page française préparée pour Templates dans la documentation UGSo Open Source.
---
# Templates
...
La page anglaise correspondante est actuellement la référence de structure : [`en/projects/uix/using/templates.md`](/en/projects/uix/using/templates).
